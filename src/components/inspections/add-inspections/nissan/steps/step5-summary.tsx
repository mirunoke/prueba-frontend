...
const Step5Summary: React.FC<Step5Props> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <h3 className="text-lg font-semibold">Estado de las luces frontales</h3>
        </CardHeader>
        <CardBody>
          <div className="flex items-center gap-2 mb-2">
            ...
            <span
              className={`ml-2 inline-block px-3 py-1 rounded-full border ${getStatusClass(frontLightsStatus)} text-xs`}>
              {frontLightsStatus === "Buen Estado" 
                ? "No requiere acción" 
                : frontLightsStatus === "Cambio Recomendado" 
                  ? "Atención próxima" 
                  : "Atención inmediata"}
            </span>
          </div>
      ...
      <Card>
        <CardHeader>
          <h3 className="text-lg font-semibold">Estado de las luces posteriores</h3>
        </CardHeader>
        <CardBody>
          <div className="flex items-center gap-2 mb-2">
            ...
            <span
              className={`ml-2 inline-block px-3 py-1 rounded-full border ${getStatusClass(rearLightsStatus)} text-xs`}>
              {rearLightsStatus === "Buen Estado" 
                ? "No requiere acción" 
                : rearLightsStatus === "Cambio Recomendado" 
                  ? "Atención próxima" 
                  : "Atención inmediata"}
            </span>
          </div>
