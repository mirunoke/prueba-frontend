...
import { useGetNissanVehicles } from "@/hooks/inspections/add-inspections/nissan/useGetNissanVehicles";
...
const Step2SelectVehicle: React.FC<Step2Props> = ({
  ...
  const { vehicles, loading, error } = useGetNissanVehicles();
      ...
      <div className="space-y-6">
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200">
          ...
          <p className="text-yellow-700">
            No se encontraron vehículos Nissan pendientes de inspección. Todos los vehículos Nissan ya han sido inspeccionados o no hay vehículos Nissan registrados.
          </p>
        </div>
